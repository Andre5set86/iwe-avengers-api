...
public class TokenGenerator {
	...
	public String getToken() {
		...
		final String clientId = "4su75nq84a2p2vas6q34s48o3u";
		final String userPoolId = "us-east-1_xSNuCjJmN";
		...
		initiateAuthRequest.addAuthParametersEntry("USERNAME", "andre.pinto");
